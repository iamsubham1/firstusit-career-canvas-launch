          ...
          ...new Array(2).fill(0).map((_, index) => (
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <div className="p-10 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-lg shadow-primary/10 max-w-xs w-full bg-white dark:bg-black" key={i}>
      ...
      <div className="container z-10 mx-auto">
        ...
        >
          <div className="flex justify-center">
            <div className="border border-gray-300 dark:border-gray-700 py-1 px-4 rounded-lg text-gray-900 dark:text-white">Testimonials</div>
          </div>
